...
CUDA_VISIBLE_DEVICES=0,1,2 python main.py --batch_size 256 --method self-supervision --width 16 --source mnist --target svhn_extra --num_batches_per_test 10000 --nepoch 100 --lr 0.1 --milestone_1 50 --milestone_2 75 --rotation --outf 'output/ms_SS_label'