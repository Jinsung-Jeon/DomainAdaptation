...
def labeling(args, model, tg_tr_loader):
    ...
    excerpt, pseudo_labels, inputs_z = guess_pseudo_labels(out_F_1_total, inputs_idx)

    return excerpt, pseudo_labels, inputs_z

def train_d(args, net, ext, sstasks, criterion_cls, criterion_d, optimizer_cls, scheduler, sc_tr_loader, sc_tr_dataset,sc_te_loader, tg_tr_dataset, excerpt, pseudo_labels, input_z):
    import pdb
    pdb.set_trace()
