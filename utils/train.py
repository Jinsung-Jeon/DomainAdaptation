...
def train_d(args, net, ext, sstasks, criterion_cls, criterion_d, optimizer_cls, scheduler, sc_tr_loader, sc_tr_dataset, tg_tr_dataset, excerpt, pseudo_labels, input_z):
    import pdb
    pdb.set_trace()
